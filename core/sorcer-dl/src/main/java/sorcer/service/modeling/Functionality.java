...
public interface Functionality<T> extends Identifiable, ent<T> {
	...
	public enum Type {
		...
		NEURON, VAR, SRV, LAMBDA, VAL, THRESHOLD, BIAS, FUNCTION, DATA, CONTEXT, ARRAY, LIST, ROUTINE, MODEL, DOMAIN,
		DISCIPLINE, EXERTION, MOGRAM, SELF, CONDITION, FIDELITY, LOCATOR, ARG, PATH, CONFIG, PROXY, OBJECTIVE_GRADIENT,
		CONSTRAINT_GRADIENT, COUPLED, MADO,
