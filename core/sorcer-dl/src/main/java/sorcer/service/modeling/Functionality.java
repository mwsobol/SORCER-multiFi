...
public interface Functionality<T> extends Identifiable, ent<T> {
	...
	public enum Type implements Arg { SIGNATURE,
		INPUT, DESIGN_INPUT, CONSTANT, PARAMETER, DOMAIN_CONSTANT, INVARIANT, OUTPUT, SHARED, INOUT, RESPONSE, DESIGN, INITIAL_DESIGN, PARAMETRIC,
		LINKED, CONSTRAINT, OBJECTIVE, DERIVATIVE, GRADIENT, RANDOM, BOUNDED, FUNDAMENTAL, RAW, DELEGATION, COMPOSITION,
		MULTIVAL, PRED, DOMAIN_PRED, DEP, DOMAIN_DEP, FILTER, PERSISTER, EVALUATOR, EVALUATION, PRODUCT, WATCHABLE, ENT, PCR, DUAL,
		...
		SUPERVISOR, DEVELOPER, EXECUTION, STRATEGY, EXEC, SCOPE, ARGS,
        // in Model Pattern
        // All-at-Once (AAO),
		...
		// Response, Analysis, Explore
		 AAO, SAND, PAR, IDF, MDF, MDA, MRPH, RESP, FNL, ANAL, EXPL, SNAP, NONE,
