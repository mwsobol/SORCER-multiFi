...
//        collab.setExplorer(new Explorer(collab));
    ...
    public static Object inst(String name, Signature builder) throws SignatureException {
        Object obj = sorcer.co.operator.instance(builder);
        if (obj instanceof Slot) {
            (( Slot ) obj).setBuilder(builder);
            if (name != null) {
                (( Slot ) obj).setKey(name);
            }
        }
        return obj;
    }

    public static Object inst(Signature builder, Context initContext) throws SignatureException {
        builder.setScope(initContext);
        Object obj = inst(builder);
        return obj;
    }

    public static Object inst(String name, Signature builder, Context initContext) throws SignatureException {
        builder.setScope(initContext);
