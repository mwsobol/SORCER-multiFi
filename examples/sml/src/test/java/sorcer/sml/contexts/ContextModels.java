...
//		Copier cp = copier(mdl1, args("arg/x1", "arg/x2"), mdl2, args("y1", "y2"));
...
//	}
	...
	public void evaluateMultiEntryResponseModel() throws Exception {
		...
		add(mdl, ent("add", invoker("x1 + x3", args("x1", "x3"))));

		add(mdl, ent("multiply", invoker("x4 * x5", args("x4", "x5"))));
	...
	public void invokerEntryService() throws Exception {
		...
		Entry ie = ent("multiply", invoker("x1 * x2", args("x1", "x2")));
