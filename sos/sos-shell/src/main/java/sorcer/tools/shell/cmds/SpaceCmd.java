 ...
 * pcr the 'help sp' command at the nsh prompt
 */
public class SpaceCmd extends ShellCmd {

	{
		...
		COMMAND_HELP = "Support for exertion spaces; 'space' mode"
				...
				+ "\n  -a   show all space domains, set the 'exertion' mode"
				+ "\n  -d   show done space domains, set the 'exertion' mode"
				+ "\n  -f   show failed space domains, set the 'exertion' mode"
				...
				+ "\n  -ta   take all domains from the Space"
